...
namespace LibraryManagementSystem.Views
{
    public partial class AdminDashboardWindow : Window
    {
        ...
        {
            string searchText = txtSearchBook.Text.ToLower();
        ...
        {
            txtTotalBooks.Text = currentBooks.Count.ToString();
        ...
        private void btnDeleteBook_Click(object sender, RoutedEventArgs e)
        {
            ...
            Book selectedBook = filteredBooks[selectedIndex];
        ...
        private void btnUpdateBook_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (!int.TryParse(txtEditStock.Text, out int stock))
            {
            ...
            selectedBook.ISBN = txtEditISBN.Text;
            selectedBook.Category = txtEditCategory.Text;
        ...
        private void lstBooks_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            txtEditISBN.Text = selectedBook.ISBN;
            txtEditCategory.Text = selectedBook.Category;
            txtEditStock.Text = selectedBook.Stock.ToString();
        }
        ...
        private void btnDashboard_Click(object sender, RoutedEventArgs e)
        {
            ...
            BorrowedPanel.Visibility = Visibility.Collapsed;
        ...
        private void btnBorrowedBooks_Click(object sender, RoutedEventArgs e)
        {
            DashboardPanel.Visibility = Visibility.Collapsed;
            BooksPanel.Visibility = Visibility.Collapsed;
            BorrowedPanel.Visibility = Visibility.Visible;
            HistoryPanel.Visibility = Visibility.Collapsed;
            UsersPanel.Visibility = Visibility.Collapsed;
        }
        ...
        private void UpdateUserRole(string role)
        {
            ...
            currentUsers[selectedIndex].Role = role;

            SaveUsers();

            LoadUsers();

            txtSelectedRole.Text = role;
